<template>
  <el-row>
    <el-col
         ...
         >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div>
                <span style="font-size: 12px;color: #3699FF;cursor: pointer;margin-right: 10px"
      ...
      <cc-drawer v-if="drawer" class="drawer-wrapper" v-model="drawerVisible" :title="drawerTitle">
